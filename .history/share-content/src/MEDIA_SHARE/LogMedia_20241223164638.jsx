  ...
  const handleInstagramLogin = () => {
    if (window.FB) {
      FB.login(
        ...
        {
          scope:"instagram_basic,instagram_content_publish,instagram_manage_comments,instagram_manage_insightsinstagram_shopping_tag_products,pages_show_list,pages_read_engagement,
