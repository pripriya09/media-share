  ...
  const handleFBLogin = () => {
    if (window.FB) {
      FB.login(
        ...
        {
          scope: "pages_show_list business_management,pages_manage_posts,pages_read_engagement,instagram_basic,instagram_content_publish,instagram_manage_comments",
        }
      );
    } else {
