...
import otherRoutes from './routes/authRoutes.js';
...
// Use the authRoutes for login operations
...
// Endpoint to login via Facebook and link Instagram account
...
//       `https://graph.facebook.com/v21.0/me/accounts`,
//       {
//         params: { access_token: facebookAccessToken, appsecret_proof: appSecretProof },
//       }
//     );
  ...
  try {
    ...
    res.status(500).json({
      error:
        ...
        "Error occurred while posting on Instagram.",
    });
  }
});
